...
const defaultContent: SiteContent = {
  hero: {
    ...
    subtitle: 'Наставник с 16-ти летним опытом. Помогаю создать уникальные впечатления и увеличить прибыль вашего бара или ресторана.'
  },
  about: {
...
const Index = () => {
  ...
  const servicePrices: { [key: string]: number } = {
    'Аудит бара или ресторана': 40000,
    'Разработка концепции': 35000,
    'Обучение персонала': 55000,
    'Меню-инжиниринг': 70000,
    'Антикризисное управление': 120000,
    'Операционное сопровождение / Наставничество': 190000
  };
